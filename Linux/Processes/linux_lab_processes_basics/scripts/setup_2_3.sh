#!/bin/bash
# BEFORE Level 2, Clue 3: Start dummy processes for this clue.
SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"
LAB_ROOT="$(cd "$SCRIPT_DIR/.." && pwd)"
PIDFILE="$LAB_ROOT/.lab_pids_2_3"

[ -f "$PIDFILE" ] && { echo "Clue 2-3 processes already running."; exit 0; }
...
echo "✓ Dummy processes started for Clue 2-3 (2 CPU + 1 RAM)."
